function Hide-Pixel {
  ...
  .EXAMPLE
  Hide-Pixel -m "SecretMessage" -cf "C:\Images\cover.png" -sf "C:\Images\stego.png"

  .EXAMPLE
  Hide-Pixel -m (Get-Content "C:\Images\MyCopyright.txt" -raw) -cf "C:\Images\cover.png" -sf "C:\Images\stego.png" -cc RB -bpc 4
  ...
  Hide-Pixel -m $SecretRecipe -cf "C:\Images\cover.png" -sf "$env:temp\stego.png" -cc RGB -bpc 1
  ...
  Hide-Pixel -m (Get-Content "$home\Documents\SecretFile.enc" -raw) -cf "C:\Images\cover.png" -sf "$home\Documents\stego.png" -cc RGB -bpc 2
  ...
  Hide-Pixel -m (Get-Content "$home\Documents\payload.enc" -raw) -cf "C:\Images\cover.png" -sf "$home\Documents\payload.png" -cc RGB -bpc 2
  #>
  param(
