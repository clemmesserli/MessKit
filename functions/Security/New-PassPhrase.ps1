Function New-PassPhrase {
    ...
    .EXAMPLE
        C:\PS> New-PassPhrase -FourWords -Wordlist .\data\top-1000-english-words.txt -OutputFile passphrase-list.txt

        Description
        -----------
        This command will take a list of words and generate a passphrase list using four words in each passphrase.
    .EXAMPLE
        C:\PS> New-PassPhrase -FourWords -TotalLines 25 -Wordlist .\data\bitcoin-bip-0039-seed-words.txt -OutputFile passphrase-list.txt
    ...
    .EXAMPLE
        C:\PS> New-PassPhrase -Threads 20 -FourWords -Wordlist .\data\top-100-english-words-4-chars-or-more.txt -OutputFile passphrase-list.txt
