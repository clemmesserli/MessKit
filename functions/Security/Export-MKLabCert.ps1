function Export-MKLabCert {
  ...
  .EXAMPLE
  "MyLabRootCA2" | Export-MKLabCert -IncludeKey
  ...
  .EXAMPLE
  Export-MKLabCert -Subject "MyLabDocEncryption" -CertStore "CurrentUser"  -FolderPath "C:\MyCerts" -Password (ConvertTo-SecureString "GetABetterPwd" -AsPlainText -Force)
