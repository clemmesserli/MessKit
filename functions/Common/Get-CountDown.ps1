function Get-CountDown {
  ...
  .DESCRIPTION
  FCalculates and displays the remaining time until a specified date or pre-set event, providing countdown information in terms of days, hours, and minutes.
